...
| 3 | Grade retrieval | "How am I doing in CS 101?" | Returns current grades/scores | |
| 4 | Syllabus access | "Show me the syllabus for Math 200" | Returns syllabus content from Canvas | |
| 5 | Announcement query | "Any new announcements?" | Lists recent course announcements | |
| 6 | Flexible course matching | "What's due in intro to programming?" | Matches course by name, not just ID | |
